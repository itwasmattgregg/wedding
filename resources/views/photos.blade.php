...
@section('bodyClasses', 'photos')

@section('content')
@include('partials.header', ['title' => 'Engagement Photos', 'background' => 'DSC_1773.jpg'])
		...
		<div class="grid" itemscope itemtype="http://schema.org/ImageGallery">
			...
			@foreach ($files as $file)
				@if(File::extension($file) == "jpg")
					...
					@endphp
					<figure>
						<a class="grid-item" href="{{ $file }}" data-size="{{ $width }}x{{ $height }}">
			...
			@endforeach
			<figure>
				<a class="grid-item" href="/images/rachel.gif" data-size="1485x992">
					<img class="img-responsive" src="/images/rachel.gif" alt="Isn't she lovely? :)" />
				</a>
			</figure>
		</div>
	</div>
